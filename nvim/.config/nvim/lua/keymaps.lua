...
vim.keymap.set('n', '<leader>te', ts_errors_to_quickfix, { noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>do', '<cmd>lua vim.lsp.buf.code_action()<CR>', { noremap = true, silent = true })
...
vim.keymap.set('n', '<leader>lr', '<cmd>lua vim.lsp.buf.remove_workspace_folder()<CR>', { noremap = true, silent = true })
vim.keymap.set('n', '<leader>ll', '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>', { noremap = true, silent = true })
